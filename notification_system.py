...
class NotificationSystem:
    def __init__(self,conn):
        ...
        self.today_str = self.now.strftime("%B %d").lower()
        self.today_day = self.now.strftime("%A").lower()
    # Email function 
    ...
    def send_event_notifications(self):
        print(f"[INFO] Checking for events occurring on {self.today_str} ({self.today_day})")
